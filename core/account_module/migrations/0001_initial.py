    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexuality_type', models.CharField(choices=[('آقا', 'آقا'), ('خانوم', 'خانوم')], default='آقا', max_length=10)),
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='کاربر', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
